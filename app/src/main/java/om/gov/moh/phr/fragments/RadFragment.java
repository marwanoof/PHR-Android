...
public class RadFragment extends Fragment {
    ...
    public void onAttach(@NonNull Context context) {
        ...
        ToolbarControllerInterface mToolbarControllerCallback = (ToolbarControllerInterface) context;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mMediatorCallback.isConnected()) {
                ...
                String procRADHRDUrl = API_URL_GET_RAD_HRD_INFO+ encounterInfo.getEncounterId();
