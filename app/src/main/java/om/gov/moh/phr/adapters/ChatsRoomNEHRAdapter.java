...
import om.gov.moh.phr.fragments.ChatNEHRFragment;
import om.gov.moh.phr.interfaces.AdapterToFragmentConnectorInterface;
import om.gov.moh.phr.interfaces.ToolbarControllerInterface;

public class ChatsRoomNEHRAdapter extends RecyclerView.Adapter<ChatsRoomNEHRAdapter.ViewHolder> {
    ...
    public ChatsRoomNEHRAdapter(ArrayList<ApigetMessages.Result> mStringArrayList, Context context, AdapterToFragmentConnectorInterface mCallback) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mCallback.onMyListItemClicked(obj, ChatNEHRFragment.class.getSimpleName());
            }
        });
    }
